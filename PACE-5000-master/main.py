...
#-------FUNCTIONS-------
    ...
    def applyparam(self):                                            # This function allow us to apply new parameters
        ...
        rate_mode = self.rate_mode.currentText()
        max_setpoint = 80
    ...
    def Start_m(self):                                        # Turns controller on
        ...
        self.plot_p.clear()
        choice = QtGui.QMessageBox.question(self, 'Control Mode', "Are you sure ? You could break a 8000€ device.  ",     # We put a window to warn the user
                                            QtGui.QMessageBox.Yes | QtGui.QMessageBox.No)
        if choice == QtGui.QMessageBox.Yes:
